---
layout: post
title: Kotlin Workshop with Svetlana Isakova
category:
---
...
The workshop itself happened at Google Campus TLV (a space made available by Google to support tech related user groups) and was divided in three consecutive days, four hours each day. It was **intense**, but that's what we came for!

![Svetlana Isakova teaching us Kotlin]({{ site.url }}/assets/kotlin-workshop-sveta/sveta-1.jpg){: .center-image }

![Attendees]({{ site.url }}/assets/kotlin-workshop-sveta/attendees.jpg){: .center-image }

![Day 2]({{ site.url }}/assets/kotlin-workshop-sveta/day2.jpg){: .center-image }

![Day 3]({{ site.url }}/assets/kotlin-workshop-sveta/sveta-3.jpg){: .center-image }

Svetlana is an amazing teacher. She managed to cover **all** the main features and explained to us lots of the thoughts behind the way Kotlin works. All her workshop material is available on [her Github account](https://github.com/svtk/kotlin-workshop).
...
It was **awesome** to be able to ask questions to a person who knows the ins and outs of the language so well. The whole accessibility around Kotlin (on Slack) still baffles me. Not only the Kotlin dev team is available to everyone but all the community is also present so every question get answered in a heartbeat!

Of course it's in the interest of Jetbrains to help people get on board but it's the first time I see that you can just ask directly a question to the gal or guy that wrote that feature in a programming language.

Amazing times!

![quiz]({{ site.url }}/assets/kotlin-workshop-sveta/stickers.jpg){: .center-image }

We did not write code on our computers but as so much material was covered I think it suited well the level of expertise (and availability I guess) of Svetlana. I plan to go through all of it in the next weeks and prepare exercises to go with the presentations to pass this knowledge through 2h workshops at [KotlinTLV](https://kotlintlv.co.il).

To conclude, I'd like to thank the organizers of this workshop: [Yonatan V. Levin](), [Yossi Segev]() and [Britt Barak](). They worked really hard to give us this opportunity and I thank them for their time and efforts.
