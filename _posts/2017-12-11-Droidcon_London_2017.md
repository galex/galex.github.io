...
![before the flight]({{ site.url }}/assets/droidconuk17/before-flight.jpg){: .center-image }
...
![Room]({{ site.url }}/assets/droidconuk17/room.jpg){: .center-image }
...
![Android Internals]({{ site.url }}/assets/droidconuk17/internals.jpg){: .center-image }
...
![vector drawables]({{ site.url }}/assets/droidconuk17/vectors.jpg){: .center-image }
...
![Doze]({{ site.url }}/assets/droidconuk17/android-job.jpg){: .center-image }
...
![Clean architecture]({{ site.url }}/assets/droidconuk17/clean-architecture.jpg){: .center-image }
...
![Devs are users]({{ site.url }}/assets/droidconuk17/devs-are-users.jpg){: .center-image }
...
![Dagger and RxJava in Tests]({{ site.url }}/assets/droidconuk17/dagger-rxjava-tests.jpg){: .center-image }
...
![Window]({{ site.url }}/assets/droidconuk17/window.jpg){: .center-image }
...
![Window]({{ site.url }}/assets/droidconuk17/pragmatic-kotlin.jpg){: .center-image }
...
![Journey from Java to Kotlin]({{ site.url }}/assets/droidconuk17/java-to-kotlin.jpg){: .center-image }
...
![Bytecode]({{ site.url }}/assets/droidconuk17/bytecode.jpg){: .center-image }

## Conclusion

[Here are all the videos of DroidconUK 2017](https://skillsmatter.com/conferences/8265-droidcon-london-2017#skillscasts) (two were **really** funny, I'll let you find out which ones!). Droidcon London is a **Great** conference. I learned so much and it opens the mind to new concepts. The high level of talks is totally worth it. I'll be back next year, for sure!
